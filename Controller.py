...
class Controller:
    ...
    def init_objects(self):
        ...
        objects.append(Stvol(475, 450, 0, 'stvol1.2.png', self.trunks))
        objects.append(Stvol(475, 850, 0, 'stvol1.2.png', self.trunks))
        objects.append(Stvol(275, 1100, 0, 'stvol1.2.png', self.trunks))
